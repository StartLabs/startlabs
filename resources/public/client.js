...
startlabs.maps.setup_maps = function() {
  ...
  jayq.core.$.call(null, "#job-list").masonry(jayq.util.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'itemSelector", "\ufdd0'columnWidth"], {"\ufdd0'itemSelector":".job-brick", "\ufdd0'columnWidth":390})));
  console.log("MAPPIN");
